...
<template>
	<div
		class="sticky top-0 z-10 flex h-11 w-full flex-shrink-0 items-center gap-3 bg-surface-white px-3 shadow-sm"
	>
		<div class="relative flex flex-1 items-center">
			...
			<div class="flex flex-1 items-center justify-center">
				<div class="relative flex items-center gap-3">
					...
					>
						<ShieldAlert
						class="absolute -left-6 h-4 w-4 cursor-pointer text-warn"
							stroke-width="1.5"
						/>
					</Tooltip>
					<ContentEditable
