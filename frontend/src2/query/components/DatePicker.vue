<template>
	<div class="flex w-[210px] select-none flex-col gap-2 bg-surface-white text-base">
			...
			<div class="grid w-full grid-cols-7">
				...
				<template v-for="(week, i) in daysAsWeeks" :key="i">
					<div
						...
						' rounded-l bg-surface-gray-4 !font-medium':
							fromDateTxt && toValue(date) === toValue(fromDateTxt),
						' rounded-r bg-surface-gray-4 !font-medium':
							toDateTxt && toValue(date) === toValue(toDateTxt),
						'bg-surface-gray-2 font-medium text-ink-gray-8': isInRange(date),
						}"
