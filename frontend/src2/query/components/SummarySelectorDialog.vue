...
<template>
	<Dialog :modelValue="showDialog" :options="{ size: '2xl' }">
		<template #body>
			<div class="min-w-[36rem] rounded-lg bg-surface-white px-4 pb-6 pt-5 text-base sm:px-6">
				<div class="flex items-center justify-between pb-4">
					<h3 class="text-2xl font-semibold leading-6 text-ink-gray-9">Summarize</h3>
				...
				<div class="flex flex-col gap-4">
					<div class="flex gap-4">
						<div class="flex-1 flex-shrink-0">
							<p class="mb-1.5 text-p-sm text-ink-gray-6">Group By</p>
						...
						<div class="flex-1 flex-shrink-0">
							<p class="mb-1.5 text-p-sm text-ink-gray-6">Aggregate</p>
							<div class="flex flex-col gap-2">
								<MeasurePicker
