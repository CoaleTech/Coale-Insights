...
<template>
	<div class="flex flex-col" :class="collapsed ? '' : 'pb-3.5'">
		<button
		class="sticky top-0 flex cursor-pointer items-center gap-1 bg-surface-white py-3"
		...
		>
			...
			<ChevronRight
			class="h-4 w-4 text-ink-gray-6 transition-all motion-reduce:transition-none"
