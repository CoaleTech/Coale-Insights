		...
		<div class="mt-3 flex-1 overflow-hidden p-1">
			...
			>
				...
				<li
					...
					:key="idx"
				class="flex h-10 cursor-pointer items-center gap-4 border-b transition-colors hover:bg-surface-gray-1 motion-reduce:transition-none"
				...
				<div class="flex-1 text-sm text-ink-gray-6">
			...
			<div v-else class="flex h-full w-full items-center justify-center">
				...
				<div class="text-lg text-ink-gray-6">No workbooks created</div>
