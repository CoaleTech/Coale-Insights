	...
	<div>
		<Dropdown :options="userDropdownOptions">
			<template v-slot="{ open }">
				<button
					class="flex h-12 items-center rounded-md py-2 duration-300 ease-in-out motion-reduce:transition-none"
					:class="
						props.isCollapsed
							? 'w-auto px-0'
							: open
				...
				>
					...
					/>
					<div
						class="flex flex-1 flex-col text-left duration-300 ease-in-out motion-reduce:transition-none"
						:class="
							props.isCollapsed
					...
					<div
						class="duration-300 ease-in-out motion-reduce:transition-none"
						:class="
							props.isCollapsed
								? 'ml-0 w-0 overflow-hidden opacity-0'
								: 'ml-2 w-auto opacity-100'
